...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  module_default.data("toast", (options = {}) => ({
    show: false,
  ...
  module_default.data("modal", (options = {}) => ({
    open: false,
    title: options.title || "",
  ...
  module_default.data("confirm", (options = {}) => ({
    show: false,
  ...
  module_default.data("form", (options = {}) => ({
    data: options.data || {},
    errors: {},
    submitting: false,
    validate(rules = {}) {
  ...
  module_default.data("tabs", (options = {}) => ({
  ...
  module_default.data("datatable", (options = {}) => ({
    data: options.data || [],
    ...
    get paginatedData() {
      const start2 = (this.page - 1) * this.perPage;
      const end = start2 + this.perPage;
      return this.filteredData.slice(start2, end);
    },
    get totalPages() {
  ...
  module_default.data("clockWidget", () => ({
    currentTime: "",
    currentDate: "",
    clockedIn: false,
    init() {
  ...
  module_default.data("fileUpload", (options = {}) => ({
    files: [],
    dragging: false,
